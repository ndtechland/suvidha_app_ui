...
import 'package:suvidha_app_ui/screens/official_discome_login/discome_jee_supply_login.dart';

import '../../constants/reusable_appbar/reusable_appbar.dart';

class NewConnectiondiscomeGuideline extends StatelessWidget {
                                  ...
                                  child: Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsets.symmetric(
                                          horizontal: size.width * 0.01),
                                      child: Text(
                                        'Agriculture Connection will be given only by Discome JEE Supply of the area where New Agriculture Connection is desired through this app.',
                                  ...
                                  child: Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsets.symmetric(
                                          ...
                                          vertical: size.height * 0.01),
                                      child: Text(
                                        '*Discome JEE Supply of the area needs to Login by clicking "Discom Login" button below to apply for the Agriculture Connection.',
                                        style: GoogleFonts.poppins(
