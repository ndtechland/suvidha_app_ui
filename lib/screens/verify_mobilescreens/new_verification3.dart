...
import 'package:suvidha_app_ui/screens/select_connection_dashbord/select_connection_type_dashbord.dart';

import '../../constants/reusable_appbar/reusable_appbar.dart';

class Verifyotp3 extends StatelessWidget {
  final GlobalKey<FormState> _formconnection2Key = GlobalKey<FormState>();
  @override
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Text(
                    'Select Discom Office nearest to the premise where New Connection is desired.',
...
// Remove outer border completely
              ...
              HorizontalButton(
                text: 'NEXT',
                onClick: () {
                  Get.to(SelectConnectionDashbord());
