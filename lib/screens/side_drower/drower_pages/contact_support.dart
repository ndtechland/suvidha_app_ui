...
final Uri _url =
    Uri.parse('http://hargharbijli.bsphcl.co.in/Grievanceportal/default.aspx');
...
_launchWhatsapp() async {
  ...
  var whatsappAndroid =
      Uri.parse("whatsapp://send?phone=$whatsapp&text=Hi Suvidha");
