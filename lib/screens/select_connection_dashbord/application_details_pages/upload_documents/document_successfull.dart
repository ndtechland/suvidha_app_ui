...
class SucessfullDocumentsupload extends StatelessWidget {
  SucessfullDocumentsupload({Key? key}) : super(key: key);
                ...
                child: Obx(
                  () => Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: selectionController.selectedIndices.contains(0)
                            ? Colors.white
                            : Colors.transparent,
                        width: 3,
                      ),
                      gradient: selectionController.selectedIndices.contains(0)
                          ? AppColors.gradient5
                          : AppColors.gradient11,
                    ),
                    child: ThreeDtext(
                      text: "CLOSE",
                      fontColor: selectionController.selectedIndices.contains(0)
                          ? Colors.white
                          : Colors.black,
                      fontSize: size.width * 0.045,
